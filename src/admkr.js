 ...
 *
 * @license Copyright (c) 2017, Christopher C. Moody. All rights reserved.
 * 
 * @author: Christopher C. Moody, chris@moodydigital.com
 */
(function(className){
	var _instances={}, _count=0, admkr.styles;
	
	/**
	 * @constructor
	 * @description Initializes a new admkr instance, creating a container element with the supplied options in the process
	...
	**/
	 ...
	 * @param {Element=} parent - The Element to append the new element. Defaults to this admkr's container
	...
	**/
	 ...
	 * @function on
	 * @static
	 * @description Add a listener to a single object, group using an array or selector. IE9 +
	 * @param {*} target - A selector string, Array, or element
	...
	**/
	 ...
	 * @function off
	 * @static
	 * @description Remove a listener to a single object, group using an array or selector.
	 * @param {*} target - A selector string, Array, or element
	 * @param {string} eventType - A string representing the type of event the listener is associated with
	 * @param {function} callback - The function to be executed when the associated event is fired
	**/
